...
const CheckoutPage = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      const { paymentUrl } = await paymentApi.createPayosUrl(
        accessToken,
        selectedPlan,
      );
      ...
      setErrorMessage(
        error.response?.data?.message || "Không tạo được link PayOS.",
      );
      setIsPaying(false);
    }
  };
            ...
            <div className="bg-[#2a2a2d] rounded-xl p-6 border border-gray-700 sticky top-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="border-t border-gray-700 pt-3 flex justify-between">
                  ...
                  <span className="text-2xl font-bold text-[#ffdd95]">
                    {plan.price}
                  </span>
                </div>
              </div>
              ...
              >
                <FaLock />{" "}
                {isPaying ? "Đang chuyển đến PayOS..." : "Thanh toán ngay"}
              </button>
