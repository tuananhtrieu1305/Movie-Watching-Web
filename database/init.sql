...
--
-- Host: 127.0.0.1    Database: movie_streaming_db
-- ------------------------------------------------------
...
CREATE TABLE `notifications` (
  ...
  `type` enum('system','vip','new_episode','reply','like','warning') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_type` enum('production','episode','comment','transaction','user') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `production_actors` (
  ...
  `character_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `character_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role_type` enum('cast','director','writer','producer','crew') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'cast',
...
INSERT INTO `production_genres` VALUES (1,1),(2,1),(6,1),(12,1),(13,1),(14,1),(15,1),(18,1),(25,1),(26,1),(27,1),(7,2),(11,3),(18,3),(19,3),(28,3),(29,3),(2,5),(6,5),(8,5),(10,5),(21,5),(27,5),(30,5),(4,7),(20,9),(5,10),(23,10),(26,10),(7,11),(19,11),(24,12),(1,15),(6,15),(4,16),(13,16),(22,16),(25,16),(3,17),(5,17),(7,17),(9,17),(14,17),(22,17),(23,17),(24,17),(1,18),(3,18),(15,18),(16,18),(17,18),(18,18),(20,18),(21,18),(26,18),(30,18),(2,19),(8,19),(10,19),(15,19),(11,20),(19,20),(28,20),(29,20),(11,21),(12,23),(17,23),(12,25),(14,25),(15,25),(16,25),(22,25),(24,25),(25,25),(9,26),(28,26),(9,28),(11,28),(3,31),(5,31),(14,31),(4,32),(19,32),(29,35),(12,37),(13,37),(16,37),(17,37),(23,38),(17,40),(8,42),(21,42),(30,42),(13,47),(18,47),(20,48),(10,49),(27,49),(16,50),(20,50);
...
CREATE TABLE `productions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` enum('movie','season','series') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `status` enum('ongoing','completed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ongoing',
...
INSERT INTO `productions` VALUES (1,'movie','The Dark Knight','the-dark-knight','Phim siêu anh hùng về Batman','https://upload.wikimedia.org/wikipedia/vi/2/2d/Poster_phim_K%E1%BB%B5_s%C4%A9_b%C3%B3ng_%C4%91%C3%AAm_2008.jpg','https://wallpapercave.com/wp/wp15069153.webp','completed',2008,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:38:08','English'),(2,'movie','Inception','inception','Phim hành động khoa học viễn tưởng','https://play-lh.googleusercontent.com/buKf27Hxendp3tLNpNtP3E-amP0o4yYV-SGKyS2u-Y3GdGRTyfNCIT5WAVs2OudOz6so5K1jtYdAUKI9nw8=w240-h480-rw','https://wallpapercave.com/wp/wp13309217.jpg','completed',2010,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:55:22','English'),(3,'movie','Parasite','parasite','Phim điện ảnh Hàn Quốc đoạt Oscar','https://m.media-amazon.com/images/M/MV5BYjk1Y2U4MjQtY2ZiNS00OWQyLWI3MmYtZWUwNmRjYWRiNWNhXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg','https://wallpapercave.com/wp/wp5264426.jpg','completed',2019,0,'South Korea',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:52:43','Korean'),(4,'movie','Spirited Away','spirited-away','Phim hoạt hình Nhật Bản của Studio Ghibli','https://m.media-amazon.com/images/I/71zqphejhbL._AC_UF894,1000_QL80_.jpg','https://wallpapercave.com/wp/wp12656391.jpg','completed',2001,0,'Japan',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:51:23','Japanese'),(5,'movie','The Godfather','the-godfather','Phim tội phạm cổ điển','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxB5ywV-Kithb4CD65H7Z6NijynafWhW9ZR5rBSQ2QkAG5oVmibtdJ3SFO4GdYXkVFmZX8bXDdfRNMB46x3B0lyssU-eK-z3fIOyUYhOAutel4fl4hyPhkaptYRzXLZw&s=10&ec=121630504','https://wallpapercave.com/wp/wp13501388.jpg','completed',1972,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:50:28','English'),(6,'movie','Avengers: Endgame','avengers-endgame','Phim siêu anh hùng Marvel','https://i.redd.it/a40iui20osh61.jpg','https://wallpapercave.com/wp/wp6034976.jpg','completed',2019,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 03:49:32','English'),(7,'movie','Titanic','titanic','Phim tình cảm lịch sử','https://upload.wikimedia.org/wikipedia/vi/a/ab/Titanic_3D_poster_Vietnam.jpg','https://wallpapercave.com/uwp/uwp4635796.jpeg','completed',1997,0,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 03:48:13','English'),(8,'movie','The Matrix','the-matrix','Phim khoa học viễn tưởng','https://m.media-amazon.com/images/M/MV5BN2NmN2VhMTQtMDNiOS00NDlhLTliMjgtODE2ZTY0ODQyNDRhXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg','https://wallpapercave.com/wp/wp4694277.jpg','completed',1999,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:47:08','English'),(9,'movie','Forrest Gump','forrest-gump','Phim chính kịch lịch sử','https://upload.wikimedia.org/wikipedia/vi/1/1d/Forrest_gump.jpg','https://wallpapercave.com/wp/k5LcUT6.jpg','completed',1994,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 03:46:06','English'),(10,'movie','Interstellar','interstellar','Phim khoa học viễn tưởng về không gian','https://wallpapercave.com/wp/wp14859093.jpg','https://wallpapercave.com/wp/wp1817968.jpg','completed',2014,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:46:35','English'),(11,'movie','La La Land','la-la-land','Phim ca nhạc lãng mạn','https://upload.wikimedia.org/wikipedia/vi/a/ab/La_La_Land_%28film%29.png','https://i.ytimg.com/vi/GTWqwSNQCcg/maxresdefault.jpg','completed',2016,0,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:45:00','English'),(12,'movie','The Shawshank Redemption','shawshank-redemption','Phim tâm lý tội phạm','https://upload.wikimedia.org/wikipedia/vi/8/81/ShawshankRedemptionMoviePoster.jpg','https://wallpapercave.com/wp/wp2014263.jpg','completed',1994,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:43:32','English'),(13,'movie','Pulp Fiction','pulp-fiction','Phim tội phạm của Quentin Tarantino','https://m.media-amazon.com/images/I/81UTs3sC5hL._AC_UF894,1000_QL80_.jpg','https://wallpapercave.com/wp/wp3024065.jpg','completed',1994,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:42:13','English'),(14,'movie','Gladiator','gladiator','Phim lịch sử hành động','https://upload.wikimedia.org/wikipedia/vi/f/f8/GladiatorDVD.png','https://wallpapercave.com/wp/wp14633777.jpg','completed',2000,0,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:40:56','English'),(15,'movie','The Lord of the Rings: The Fellowship','lotr-fellowship','Phim fantasy đầu tiên của LOTR','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsCbqP40l_utDt0Kdj8EvLUgGOgxLWUqfbGAqU7huHJ8aPOHKB2L8c35M8dcSvhGtI_RKchBulYA-dXlM21girI4NPEHyRwi_dCXFZdwaffs8aF7NSGfDh5GeHhsz2&s=10&ec=121630504','https://wallpapercave.com/wp/wp6021426.jpg','completed',2001,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:39:27','English'),(16,'movie','Fight Club','fight-club','Phim tâm lý hành động','https://upload.wikimedia.org/wikipedia/en/f/fc/Fight_Club_poster.jpg','https://wallpapercave.com/wp/FrUiofn.jpg','completed',1999,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:14:53','English'),(17,'movie','The Silence of the Lambs','silence-lambs','Phim kinh dị tâm lý','https://upload.wikimedia.org/wikipedia/vi/8/86/The_Silence_of_the_Lambs_poster.jpg','https://wallpapercave.com/wp/wp16127463.jpg','completed',1991,0,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:37:06','English'),(18,'movie','Back to the Future','back-to-the-future','Phim khoa học viễn tưởng hài','https://upload.wikimedia.org/wikipedia/vi/d/d2/Back_to_the_Future.jpg','https://wallpapercave.com/wp/wp11330095.jpg','completed',1985,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:35:38','English'),(19,'movie','The Lion King','lion-king','Phim hoạt hình Disney','https://m.media-amazon.com/images/M/MV5BMjIwMjE1Nzc4NV5BMl5BanBnXkFtZTgwNDg4OTA1NzM@._V1_FMjpg_UX1000_.jpg','https://wallpapercave.com/wp/wp4425085.jpg','completed',1994,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:32:45','English'),(20,'movie','Jurassic Park','jurassic-park','Phim khoa học viễn tưởng về khủng long','https://m.media-amazon.com/images/I/81AGqBcpYOL._AC_UF1000,1000_QL80_.jpg','https://wallpapercave.com/wp/wp14084169.jpg','completed',1993,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:31:24','English'),(21,'series','Stranger Things','stranger-things','Series khoa học viễn tưởng','https://m.media-amazon.com/images/M/MV5BNjRiMTA4NWUtNmE0ZC00NGM0LWJhMDUtZWIzMDM5ZDIzNTg3XkEyXkFqcGc@._V1_.jpg','https://wallpapercave.com/wp/wp16041613.jpg','ongoing',2016,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:28:58','English'),(22,'series','Game of Thrones','game-of-thrones','Series fantasy chính kịch','https://m.media-amazon.com/images/M/MV5BMTNhMDJmNmYtNDQ5OS00ODdlLWE0ZDAtZTgyYTIwNDY3OTU3XkEyXkFqcGc@._V1_.jpg','https://wallpapercave.com/wp/wp4285895.jpg','completed',2011,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:26:34','English'),(23,'series','Breaking Bad','breaking-bad','Series tội phạm chính kịch','https://m.media-amazon.com/images/I/91IYswOQPhL._AC_UF1000,1000_QL80_.jpg','https://wallpapercave.com/wp/wp12099915.jpg','completed',2008,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:24:24','English'),(24,'series','The Crown','the-crown','Series lịch sử về Nữ hoàng Anh','https://m.media-amazon.com/images/M/MV5BODcyODZlZDMtZGE0Ni00NjBhLWJlYTAtZDdlNWY3MzkwMGVhXkEyXkFqcGc@._V1_.jpg','https://wallpapercave.com/wp/wp14727776.jpg','completed',2016,1,'UK',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:22:54','English'),(25,'series','The Witcher','the-witcher','Series fantasy hành động','https://m.media-amazon.com/images/M/MV5BOTQzMzNmMzUtODgwNS00YTdhLTg5N2MtOWU1YTc4YWY3NjRlXkEyXkFqcGc@._V1_.jpg','https://wallpapercave.com/wp/wp5232692.jpg','ongoing',2019,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:21:07','English'),(26,'series','Money Heist','money-heist','Series tội phạm Tây Ban Nha','https://resizing.flixster.com/ITt1FPrFePNR6FSqZrZK7BocG2U=/ems.cHJkLWVtcy1hc3NldHMvdHZzZWFzb24vUlRUVjEwMTMyOTMud2VicA==','https://wallpapercave.com/wp/wp15188366.webp','completed',2017,0,'Spain',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:20:04','Spanish'),(27,'series','The Mandalorian','the-mandalorian','Series Star Wars','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFo-L4z5CuNuGxpLdJ7-mRK6dpjCemsFBGdiLuIkI0GhrUXL4towrTL03dR1jJoV6yVU1pyMmpbDDGIEYbVupJMLDny1pHmd0xfUgPyo1C1y3MbAbCz3lMnct_QittPg&s=10&ec=121630504','https://wallpapercave.com/wp/wp15268964.jpg','ongoing',2019,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:18:57','English'),(28,'series','Friends','friends','Series hài kịch tình huống','https://media.posterstore.com/site_images/68631cf30b074212f55c844b_472608644_WB0074-8.jpg','https://wallpapercave.com/wp/wp16171743.jpg','completed',1994,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:17:36','English'),(29,'series','The Office','the-office','Series hài kịch mockumentary','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYYIHH55nOWyDuFOqIpJWbHFyXdEUAq9CCEmxyef1lIryre98784Gf58fjyIxOEfWH5pNmeLWhTHK8gbDk_KLhT5VN2Ydy3b6Cc_5jEKkZMRwxtuzfUFfOYsSkWhW7n5mW&s=10&ec=121630504','https://wallpapercave.com/wp/wp15427073.jpg','completed',2005,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-04-13 01:16:32','English'),(30,'series','Black Mirror','black-mirror','Series khoa học viễn tưởng','https://m.media-amazon.com/images/I/81wpWknHBfL.jpg','https://wallpapercave.com/wp/wp15301742.jpg','ongoing',2011,1,'UK',4.0,1,'2026-01-22 00:36:26','2026-04-13 01:15:44','English'),(31,'season','Stranger Things - Season 1','stranger-things-season-1','Mùa đầu tiên của Stranger Things','/posters/st-season1.jpg','/banners/st-season1-banner.jpg','completed',2016,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(32,'season','Stranger Things - Season 2','stranger-things-season-2','Mùa thứ hai của Stranger Things','/posters/st-season2.jpg','/banners/st-season2-banner.jpg','completed',2017,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(33,'season','Stranger Things - Season 3','stranger-things-season-3','Mùa thứ ba của Stranger Things','/posters/st-season3.jpg','/banners/st-season3-banner.jpg','completed',2019,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(34,'season','Stranger Things - Season 4','stranger-things-season-4','Mùa thứ tư của Stranger Things','/posters/st-season4.jpg','/banners/st-season4-banner.jpg','completed',2022,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(35,'season','Game of Thrones - Season 1','game-of-thrones-season-1','Mùa đầu tiên của Game of Thrones','/posters/got-season1.jpg','/banners/got-season1-banner.jpg','completed',2011,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(36,'season','Game of Thrones - Season 2','game-of-thrones-season-2','Mùa thứ hai của Game of Thrones','/posters/got-season2.jpg','/banners/got-season2-banner.jpg','completed',2012,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(37,'season','Game of Thrones - Season 3','game-of-thrones-season-3','Mùa thứ ba của Game of Thrones','/posters/got-season3.jpg','/banners/got-season3-banner.jpg','completed',2013,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(38,'season','Breaking Bad - Season 1','breaking-bad-season-1','Mùa đầu tiên của Breaking Bad','/posters/bb-season1.jpg','/banners/bb-season1-banner.jpg','completed',2008,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(39,'season','Breaking Bad - Season 2','breaking-bad-season-2','Mùa thứ hai của Breaking Bad','/posters/bb-season2.jpg','/banners/bb-season2-banner.jpg','completed',2009,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(40,'season','Breaking Bad - Season 3','breaking-bad-season-3','Mùa thứ ba của Breaking Bad','/posters/bb-season3.jpg','/banners/bb-season3-banner.jpg','completed',2010,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(41,'season','The Crown - Season 1','the-crown-season-1','Mùa đầu tiên của The Crown','/posters/crown-season1.jpg','/banners/crown-season1-banner.jpg','completed',2016,1,'UK',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(42,'season','The Crown - Season 2','the-crown-season-2','Mùa thứ hai của The Crown','/posters/crown-season2.jpg','/banners/crown-season2-banner.jpg','completed',2017,1,'UK',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(43,'season','The Witcher - Season 1','the-witcher-season-1','Mùa đầu tiên của The Witcher','/posters/witcher-season1.jpg','/banners/witcher-season1-banner.jpg','completed',2019,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(44,'season','The Witcher - Season 2','the-witcher-season-2','Mùa thứ hai của The Witcher','/posters/witcher-season2.jpg','/banners/witcher-season2-banner.jpg','completed',2021,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(45,'season','Money Heist - Season 1','money-heist-season-1','Mùa đầu tiên của Money Heist','/posters/mh-season1.jpg','/banners/mh-season1-banner.jpg','completed',2017,0,'Spain',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','Spanish'),(46,'season','Money Heist - Season 2','money-heist-season-2','Mùa thứ hai của Money Heist','/posters/mh-season2.jpg','/banners/mh-season2-banner.jpg','completed',2018,0,'Spain',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','Spanish'),(47,'season','The Mandalorian - Season 1','mandalorian-season-1','Mùa đầu tiên của The Mandalorian','/posters/mando-season1.jpg','/banners/mando-season1-banner.jpg','completed',2019,1,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(48,'season','The Mandalorian - Season 2','mandalorian-season-2','Mùa thứ hai của The Mandalorian','/posters/mando-season2.jpg','/banners/mando-season2-banner.jpg','completed',2020,1,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(49,'season','Friends - Season 1','friends-season-1','Mùa đầu tiên của Friends','/posters/friends-season1.jpg','/banners/friends-season1-banner.jpg','completed',1994,0,'USA',5.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English'),(50,'season','Friends - Season 2','friends-season-2','Mùa thứ hai của Friends','/posters/friends-season2.jpg','/banners/friends-season2-banner.jpg','completed',1995,0,'USA',4.0,1,'2026-01-22 00:36:26','2026-01-22 00:36:26','English');
...
CREATE TABLE `transactions` (
  ...
  `status` enum('pending','success','failed','cancelled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `payment_method` enum('momo','vnpay','zalopay','credit_card') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_gateway_response` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `users` (
  ...
  `avatar_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '/default-avatar.png',
...
CREATE TABLE `watch_parties` (
  ...
  `status` enum('waiting','playing','paused','ended') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'waiting',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `watch_party_participants` (
  `party_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` int NOT NULL,
  `role` enum('host','co-host','participant') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'participant',
...
-- Dump completed on 2026-04-13 10:58:32
